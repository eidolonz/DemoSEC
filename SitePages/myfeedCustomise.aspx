    ...
    <div class="container">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <div class="mybox1" id="myfeedCustomise" style="background: linear-gradient(#a6d4cf,#cce0c0)">
                    <div class="col-xs-12 col-md-12" style="text-align: left;">
                        ...
                        <div class="row" runat="server" id="byContent" visible="false">
                        ...
                        <div runat="server" class="row sub-content" id="lawReg" visible="false">
                            <div class="col-xs-12">
                        ...
                        <div class="row" runat="server" id="byCategories" visible="false">
                            <div class="col-xs-10 col-md-5">
                        ...
                        <div runat="server" class="row sub-content" id="category" visible="false">
                            <div class="col-xs-12">
